...
class AuthInterceptor extends QueuedInterceptor {
  ...
  //   final accessToken = await SecureStorage.instance.read('token');
  //   return accessToken;
  // }
  ...
  Future<Map<String, dynamic>> _createHeader(
    ...
    // final accessToken =
    //     navigatorKey.currentState!.context.read<AuthCubit>().stat

    final accessToken = await SecureStorage.instance.read(
      AppStrings.accessToken,
    );
    final token = accessToken?.isNotEmpty ?? false ? accessToken : null;
